    ...
    <>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" width="1em" height="1em">
        <g fill="#8a4182">
          ...
          <path d="M64 1.41A62.59 62.59 0 10126.59 64 62.59 62.59 0 0064 1.41zm-.34 111.5a49.5 49.5 0 1149.5-49.5 49.5 49.5 0 01-49.5 49.51z" />
          <path d="M61.58 82.99h3.92v19.51h-3.92zM82.838 70.95l1.211-3.728 18.555 6.029-1.211 3.728zM77.754 47.062l-3.171-2.304L86.05 28.974l3.172 2.304zM53.352 44.759l-3.172 2.304L38.713 31.28l3.171-2.304zM43.395 67.224l1.211 3.728-18.555 6.029-1.211-3.728z" />
        </g>
      </svg>
    </>
  );
